...
const translations = {
    ...
    ar: {
        ...
        hero_description: "اكتشف عقارات استثنائية في قلب الإمارات مع العمارية للعقارات",
        hero_cta: "استكشف العقارات",
        hero_cta_contact: "تواصل معنا",

        // About Section
        about_title: "عن العمارية",
        about_subtitle: "شريكك الموثوق في العقارات",
        about_p1: "العمارية للعقارات هي وجهتك الأولى للعقارات الفاخرة في عجمان، الإمارات. مع سنوات من الخبرة في سوق العقارات، نتخصص في ربط العملاء بمنازل أحلامهم وفرص الاستثمار.",
        ...
        footer_rights: "© 2025 العمارية للعقارات. جميع الحقوق محفوظة.",
